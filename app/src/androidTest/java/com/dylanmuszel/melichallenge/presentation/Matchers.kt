...
fun withDrawable(
    ...
    override fun matchesSafely(view: View): Boolean {
        ...
        val expectedBitmap = ContextCompat.getDrawable(context, id)!!.tinted(tintColor, tintMode).toBitmap()
    ...
    private fun Drawable.tinted(@ColorInt tintColor: Int? = null, tintMode: PorterDuff.Mode = PorterDuff.Mode.SRC_IN) = apply {
